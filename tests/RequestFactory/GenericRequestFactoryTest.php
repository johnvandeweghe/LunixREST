...
class GenericRequestFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGetters()
    {
        ...
        $mockedHeaderParser = $this->getMockBuilder('\LunixREST\RequestFactory\HeaderParser\HeaderParser')->getMock();
    ...
    private function mockURLParser($endpoint, $element, $version, $apiKey, $acceptableMIMETypes, $queryString)
    {
        ...
        $mockedParsedURL = $this->getMockBuilder('\LunixREST\RequestFactory\URLParser\ParsedURL')->disableOriginalConstructor()->getMock();
    ...
    {
        $mockedParsedHeaders = $this->getMockBuilder('\LunixREST\RequestFactory\HeaderParser\ParsedHeaders')->disableOriginalConstructor()->getMock();
