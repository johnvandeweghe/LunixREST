...
class RegisteredResponseFactoryTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $mockedSerializer = $this->getMockBuilder('\LunixREST\Server\ResponseFactory\APIResponseDataSerializer')->getMock();
    ...
    {
        $mockedResponseData = $this->getMockBuilder('\LunixREST\Server\APIResponse\APIResponseData')->disableOriginalConstructor()->getMock();
        $mimeType = 'application/test';
