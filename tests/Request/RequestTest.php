...
class RequestTest extends \PHPUnit_Framework_TestCase {
    public function testCreate(){
        //URL test
        $request = Request::createFromURL('get', [], [], '', '/1.0/public/helloworld/1000.json');
        ...
        $request = Request::createFromURL('get', [], [], '', '/1.0/public/helloworld.json');
        $this->assertEquals('getAll', $request->getMethod(), 'method without instance should be parsed out of URLS');

        //No url test
        $request = new Request('get', [], [], '', '1.0', 'public', 'helloworld', 'json', '1000');
