...
class BasicRequestFactoryTest extends \PHPUnit_Framework_TestCase
{
    public function testUsesDefaultsAndBasic()
    {
        ...
        $this->assertInstanceOf('\LunixREST\Request\BodyParser\BodyParserFactory\DefaultBodyParserFactory',
            $requestFactory->getBodyParserFactory());
        $this->assertInstanceOf('\LunixREST\Request\HeaderParser\DefaultHeaderParser',
